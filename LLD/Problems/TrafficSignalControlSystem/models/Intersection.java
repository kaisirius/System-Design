...
import LLD.Problems.TrafficSignalControlSystem.states.intersection.IntersectionState;
import LLD.Problems.TrafficSignalControlSystem.states.intersection.NorthSouthGreenState;
...
public class Intersection implements Runnable {
  ...
  private Intersection(int id, Map<Direction, TrafficLight> trafficLights, long greenDuration, long yellowDuration) {
      this.id = id;
