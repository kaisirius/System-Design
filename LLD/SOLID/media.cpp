...
class RecordablePlayers: public Player {
public:
  virtual void record(const string& destination) = 0;  
};

class LiveStreamPlayers: public Player {
public:
  virtual void streamLive(const string& url) = 0;  
};

class DownloadablePlayers: public Player {
public:
  virtual void download(const string& sourceUrl) = 0;   
};

class AudioPlayer : public DownloadablePlayers {
    bool playing{false};
public:
...
class CameraStreamPlayer : public RecordablePlayers, LiveStreamPlayers {
